                ...
                <div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                    <div class="w-full max-w-md space-y-8">
                        <div>
                            ...
                            <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Regisztráció</h2>
                        </div>
{{--                        @if ($errors->any())--}}
                        ...
                        <form class="mt-8 space-y-6" action="" method="POST">
                            ...
                            <div class="-space-y-px rounded-md shadow-sm">
                                ...
                                <div>
                                    ...
                                    <input id="email-address" name="email" type="email" class="relative block w-full border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Email address"
                                           value="{{ old('email') }}"
                                    >
                                    @error('email')
                                    <small class="mt-1 block bg-cyan-500 text-sm text-white p-2 mb-4 rounded">
                                ...
                                <div>
                                    ...
                                    <input id="password" name="password" type="password" class="relative block w-full rounded-b-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Password">
                                    @error('password')
                                    <small class="mt-1 block bg-cyan-500 text-sm text-white p-2 mb-4 rounded">
                                        {{ $message }}
                                    </small>
